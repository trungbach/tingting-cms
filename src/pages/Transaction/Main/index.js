    ...
    return (
        <div className={styles.content}>
            ...
            {/* <div className={styles.tabs}>
                <button
                    className={
                        location.query.tab === 'all' || location.query.tab === undefined
                            ? `${styles.active}`
                            : undefined
                    }
                    onClick={() => router.push('/home/transaction?tab=all')}
                >
                    {formatMessage({ id: 'ALL_TRANSACTIONS' })}
                </button>
                <button
                    className={location.query.tab === 'deposit' ? `${styles.active}` : undefined}
                    onClick={() => router.push('/home/transaction?tab=deposit')}
                >
                    {formatMessage({ id: 'DEPOSIT' })}
                </button>
                <button
                    className={location.query.tab === 'withdraw' ? `${styles.active}` : undefined}
                    onClick={() => router.push('/home/transaction?tab=withdraw')}
                >
